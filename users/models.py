...
class Profile(models.Model):
    ...
    profile_image = models.ImageField(
        null=True, blank=True, upload_to='uploaded-images/profiles', default='images/user-default.png')
    social_github = models.CharField(max_length=255, null=True, blank=True)
    social_stackoverflow = models.CharField(max_length=255, null=True, blank=True)
...
class Skills(models.Model):
    ...
    skillName = models.CharField(max_length=255,null=True,blank=True)
